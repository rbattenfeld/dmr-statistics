...
class RootModel implements IRootModel {
	...
	@ElementList(entry = "dmr", inline = true, required = false)
	private List<DmrModel> _genericStatisticModels;
	
	@ElementList(entry = "mbean", inline = true, required = false)
	private List<MBeanModel> _mbeanModels;
	...
	public List<DmrModel> getDmrModels() {
		return _genericStatisticModels;
	}

	@Override
	public void setDmrModels(final List<DmrModel> genericStatisticModels) {
		_genericStatisticModels = genericStatisticModels;
	}
